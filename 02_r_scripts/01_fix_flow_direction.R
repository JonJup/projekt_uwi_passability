...
dt_rivers[ecoserv_id == "rlp_10398", FROM := "P3152"]
dt_rivers[ecoserv_id == "rlp_10398", TO := "P3154"]
...
dt_rivers[ecoserv_id == "rlp_10698", FROM := "P3754"]
dt_rivers[ecoserv_id == "rlp_10698", TO := "P3750"]
dt_rivers[ecoserv_id == "rlp_10717", FROM := "P3792"]
dt_rivers[ecoserv_id == "rlp_10717", TO := "P3760"]
...
dt_rivers[ecoserv_id == "rlp_16941", FROM := "P3749"]
dt_rivers[ecoserv_id == "rlp_16941", TO := "P3649"]
dt_rivers[ecoserv_id == "rlp_16945", FROM := "P3796"]
dt_rivers[ecoserv_id == "rlp_16945", TO := "P3798"]
...
dt_rivers[ecoserv_id == "add_72920", FROM := "P3164"]
